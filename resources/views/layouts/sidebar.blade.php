                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            @if(auth()->user()->state=='manager'  )
                                ...
                                <li class="">
                                    <a href="/orders_mangement" class="waves-effect {{ request()->is("commandes") || request()->is("type_employes/*") ? "mm active" : "" }}">
                                        <i class="ti-calendar"></i> <span> Orders</span>
                                    </a>
                                </li>
                            @endif
                            ...
                            @if(auth()->user()->state=='admin' )
                                ...
                                <li class="Types_products">
                                    ...
                                    <i class="ti-list"></i> <span>Types of products </span>
                                    </a>
                                </li>
                                <li class="">
                            ...
                            @if(auth()->user()->state=='confirmateur')
                                ...
                                <li class="orders">
                                    ...
                                    <i class="ti-calendar"></i> <span>Orders shiped</span>
                                    </a>
                            </li>
                                <li class="">
                            ...
                            @if(auth()->user()->state=='manager')
                                <li class="Types_products">
                                    <a href="/Types_products_management" class="waves-effect {{ request()->is("Design") || request()->is("Design/*") ? "mm active" : "" }}">
                                    <i class="ti-list"></i> <span>Types of products </span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="/Stockage_management" class="waves-effect {{ request()->is("Design") || request()->is("Design/*") ? "mm active" : "" }}">
                                    <i class="ti-server"></i> <span>Storage </span>
                                    </a>
                                </li>
